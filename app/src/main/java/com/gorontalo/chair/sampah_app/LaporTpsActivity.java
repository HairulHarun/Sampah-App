...
public class LaporTpsActivity extends AppCompatActivity {
    ...
    private String ID, NAMA, PHOTO;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lapor_tps);
        ...
        btnKirim = (Button) findViewById(R.id.btnKirimLaporanTPS);
        ...
        btnKirim.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Dexter.withActivity(LaporTpsActivity.this)
                        .withPermissions(
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, new URLAdapter().simpanLaporanTps(), new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        startActivity(new Intent(LaporTpsActivity.this, UserActivity.class));
                    } else {
